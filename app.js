...
function showOv(t) {
  ...
  if (el) {
    el.style.cssText = 'display:flex !important; position:fixed; top:0; left:0; right:0; bottom:0; z-index:9999; align-items:flex-end; justify-content:center; background:rgba(26,10,46,0.6);';
  }
}
function closeOv(t) {
  var id = 'ov' + t.charAt(0).toUpperCase() + t.slice(1);
